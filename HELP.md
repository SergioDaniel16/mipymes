...
* The original package name 'edu.gt.umg.mipymes.contable.mipymes-contable-api' is invalid and this project uses 'edu.gt.umg.mipymes.contable.mipymes_contable_api' instead.
